...
namespace AgriRegistry.Migrations
{
    ...
    [Migration("20250103082324_AddProduceTypeAndProduceCategoryTable")]
    partial class AddProduceTypeAndProduceCategoryTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AgriRegistry.Models.Produce", b =>
                {
                    ...
                    b.HasOne("AgriRegistry.Models.ReportEntry", "ReportEntry")
                        .WithOne("Produce")
                        .HasForeignKey("AgriRegistry.Models.Produce", "ReportEntryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
